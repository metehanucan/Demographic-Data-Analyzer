...
def calculate_demographic_data(print_data=True):
    ...
    higher_education = round(df[(df['education'] =='Bachelors') | (df['education'] == 'Masters') | (df['education'] == 'Doctorate')],1)
    lower_education = round(df[(df['education'] !='Bachelors') & (df['education'] != 'Masters') & (df['education'] != 'Doctorate')],1)
